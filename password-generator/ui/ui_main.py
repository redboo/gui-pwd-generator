...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(618, 442)
        icon = QIcon()
        icon.addFile(u":/icons/images/app-icon.ico", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/images/lock.svg", QSize(), QIcon.Disabled, QIcon.On)
...
"")
        icon2 = QIcon()
        icon2.addFile(u":/icons/images/visibility_off.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u":/icons/images/visibility.svg", QSize(), QIcon.Normal, QIcon.On)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/icons/images/refresh.svg", QSize(), QIcon.Normal, QIcon.On)
...
"")
        icon4 = QIcon()
        icon4.addFile(u":/icons/images/content_copy.svg", QSize(), QIcon.Normal, QIcon.On)
